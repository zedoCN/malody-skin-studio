...
public enum ANSICode {
     ...
     * @return 重置后的文本
     */
    public static String resetStyle(Object text) {
        return RESET + text.toString() + RESET;
    }
     ...
     * @return 应用样式后的文本
     */
    public static String applyStyle(Object text, ANSICode... codes) {
        return combine(codes) + text.toString() + RESET;
    }
