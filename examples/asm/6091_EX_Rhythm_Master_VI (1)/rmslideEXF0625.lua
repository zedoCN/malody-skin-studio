...
local function loadchart()
    ...
    Diff(version)
    filename=charttitle.."_"..KNum.."k_"..DiffName..".imd"
...
local function reco()
	...
	uig2pvalue.X=207*sw1610
	uimg2pvalue.X=307*sw1610
	uiItem_ln.X=87*sw1610
	uiItem_g2p.X=187*sw1610
	uiItem_mg2p.X=287*sw1610
...
function Init()
    ...
    itembool=string.find(uimod.Text,"Const")
